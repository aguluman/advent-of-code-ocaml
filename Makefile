...
help:
	...
	@echo "  run-current     : Run the current day with input (No need to specify DAY, uses the most recent day)"
	@echo ""
	...
	@echo "  make run-current INPUT=download                        # Run day02 with specified input"
