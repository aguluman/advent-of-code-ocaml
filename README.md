...
<!-- AOC TILES END -->` in README.md
- Links point to your OCaml solution files (e.g., `2024/day01/day01.ml`)
- If session cookie exists, tiles show your completion time and rank
- Otherwise, tiles show checkmarks for completed parts
